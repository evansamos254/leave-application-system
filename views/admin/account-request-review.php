<div class="two-column">
    <section class="panel">
        ...
        <div class="button-row request-actions">
            ...
            <?php if (!empty($canAct)): ?>
                <form class="button-row" method="post" action="<?= e(url('admin/account-requests/action')) ?>">
                    <?= csrf_field() ?>
                    <input type="hidden" name="id" value="<?= (int) $request['id'] ?>">
                    <button class="btn btn-danger" type="submit" name="action" value="reject">Reject Request</button>
                    <button class="btn btn-primary" type="submit" name="action" value="approve">Approve Account</button>
                </form>
            <?php else: ?>
