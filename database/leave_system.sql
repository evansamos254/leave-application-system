...
UNION ALL SELECT id, 'Strategic Partnerships' FROM directorates WHERE name = 'Strategic Partnerships, ICT And Digital Economy'
UNION ALL SELECT id, 'ICT' FROM directorates WHERE name = 'Strategic Partnerships, ICT And Digital Economy'
UNION ALL SELECT id, 'Digital Economy' FROM directorates WHERE name = 'Strategic Partnerships, ICT And Digital Economy'
